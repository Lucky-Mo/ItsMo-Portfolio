    ...
    <div class="form-box login">
      ...
      <form action="" method="POST">
        ...
        <div class="login-register">
          <p>Don't have an account? <a href="sim-racing-website/register.php" class="register-link">Register </a></p>
        </div>
      </form>
    </div>
  </div>
...
if(isset($_POST['loginBtn'])){
  // SQL Statement
  $checkLogin = $db->prepare("SELECT * FROM tb_esimracing WHERE username = :username AND password = :password");

  // set the values of the SQL Statement
  $checkLogin->bindParam(":username", $_POST['username']);
  $checkLogin->bindParam(":password", $_POST['password']);

  // Execute
  if($checkLogin->execute()){
    // check if 1 or more users exists
